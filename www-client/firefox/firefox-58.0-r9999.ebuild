...
inherit git-r3 check-reqs flag-o-matic toolchain-funcs eutils gnome2-utils mozconfig-v6.9999 pax-utils xdg-utils autotools virtualx
...
src_configure() {
	...
	mozconfig_annotate 'Disable needs fix webrtc nox11' --disable-webrtc
	...
	#SHELL="${SHELL:-${EPREFIX}/bin/bash}" \
	#emake -f client.mk export

	#eapply "${FILESDIR}/gcc6-isnan-isinf-error.patch"
}
